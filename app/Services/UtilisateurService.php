...
class UtilisateurService
{
    ...
    {
        $validationUrl = URL::to('/utilisateurs/valider-compte', ['token' => $token->token]);
    ...
    {
        $reinitialisationUrl = URL::to('/utilisateurs/reinitialiser-tentative', ['token' => $token->token]);
    ...
    public function validerCompte($tokenStr)
    {
        ...
        if ($token->date_expiration->isBefore(Carbon::now()) || !$token) {
    ...
    public function connexion($email, $mdp)
    {
        ...
        if (!Hash::check($mdp, $utilisateur->password)) {
    ...
    public function validationPin(ValidationPinDTO $validationPinDTO)
    {
        ...
        if ($codePinEntity && !$codePinEntity->date_expiration->isBefore(Carbon::now())) {
